<template>
  <div class="w-full">
    ...
    <div v-if="website" class="w-full flex flex-col">
      <PageEditor v-model="page" :website="website" :tags="tags" :type="pageType" />
    </div>
...
import { PageType, type Page, type GetWebsiteInput, type Website, type Tag, type GetTagsInput } from '@/api/model';
