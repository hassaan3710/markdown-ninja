            ...
            <Combobox @update:modelValue="onSelect">
              <div class="grid grid-cols-1">
                <ComboboxInput :value="query" placeholder="Search..." @change="query = $event.target.value"
                  class="border-gray-100 focus:border-gray-100 focus:ring-[transparent] col-start-1 row-start-1 h-12 w-full pl-11 pr-4 text-base text-gray-900 outline-hidden placeholder:text-gray-400 sm:text-sm" />
