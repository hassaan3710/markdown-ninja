...
import { type GetPageInput, type Page } from '@/app/model';
import PageNotFound from '@/ui/components/page_not_found.vue';
import PageComponent from '@/ui/components/page.vue';
...
// functions
// function isPage() {
//   return page.value?.type === PageType.Page;
// }

// function isPost() {
//   return page.value?.type === PageType.Post;
// }
